...
public class added_notification extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(added_notification.class.getName());

    /**
     * Creates new form delete_confirmation
     */
    public added_notification() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new added_notification().setVisible(true));
    }
