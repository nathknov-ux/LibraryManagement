...
public class deleted_notification extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(deleted_notification.class.getName());

    /**
     * Creates new form delete_confirmation
     */
    public deleted_notification() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new deleted_notification().setVisible(true));
    }
