...
public class add_form_staff extends javax.swing.JFrame {
     ...
     */
    public add_form_staff(StaffPage parent, int lastID) {
       
        this.parent = parent;
        
        initComponents();
        staff_id.setText(String.valueOf(lastID + 1));
    ...
    private void initComponents() {
        ...
        addBtn = (javax.swing.JButton) new rounded_buttons(20, Color.BLACK); addBtn.setOpaque(false);
    ...
    private void addBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addBtnActionPerformed
       ...
       String fullName = surname.getText().trim().toUpperCase() + ", " + name.getText().trim();
        ...
        if (sc.addStaff(fullName, email.getText().trim(), username.getText().trim(), password.getText().trim(), role.getText().trim())) {
            added_notification a = new added_notification();
            a.setVisible(true);
            parent.allStaffTable();
            this.dispose();
        }
